...
public class date3MultiCity {
	public WebDriver driver;
	flightsInputsClass ic = new flightsInputsClass();
	public date3MultiCity(WebDriver driver) 
	{
		this.driver = driver;
	}
	
	public void date3Select() throws IOException
	{
		String firMon=null,secMon=null;
		String fuDate = ic.DepartOnDate3();
