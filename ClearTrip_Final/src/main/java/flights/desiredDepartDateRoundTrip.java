...
public class desiredDepartDateRoundTrip {
	public WebDriver driver;
	flightsInputsClass ic = new flightsInputsClass();
	public desiredDepartDateRoundTrip(WebDriver driver) 
	{
		this.driver = driver;
	}
	public void desDepartDateSel() throws IOException
	{
		String firMon=null,secMon=null;
		String fuDate = ic.DepartOnDate();
